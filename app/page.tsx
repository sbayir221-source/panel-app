...
export default function UserProfile() {
  ...
  // 2. Aktif Kullanıcının Kendi Profil Verileri (Ayarlar İçin)
  useEffect(() => {
  ...
  // 3. Profil Sayfası Verileri (Görüntülenen Kişinin Bilgileri)
  useEffect(() => {
    if (!profileId) return;
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-zinc-100 font-sans selection:bg-zinc-500/30">
      {/* ÜST BAR (NAVBAR) - Sağ üst köşedeki Ayarlar geri getirildi */}
      ...
      {/* PROFİL AYARLARI MODALI (Profil sayfasında da çalışabilmesi için eklendi) */}
      {showProfileModal && (
